...
<body>
				...
				<div class="container">
					...
					<div class="banner-grids">
						<div class="col-md-6 banner-grid">
							<h4>Classique Zoo Kids Club</h4>
							<p>The Kids Club is a fun, engaging way to experience the Zoo.</p>
						</div>
						<div class="col-md-6 banner-grid">
						<h4>Classique Zoo School</h4>
							<p>At Zoo School, we aim to provide a safe, clean, pleasant and caring environment for each child. Students may develop their physical, social, emotional and intellectual potential at their own pace, while fostering a respect for wildlife and wild places through unique Zoo interactions.</p>
						</div>
		...
		<!--header-->
			...
			<div class="content">
				<div class="welcome">
					<div class="container">
						<h2>Welcome to Classique Zoo</h2>
